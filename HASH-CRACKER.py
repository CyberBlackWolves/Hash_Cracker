...
except ImportError:os.sysyem("python2 -m pip install tqdm")
import sys
import subprocess
try:
...
if run_script == "no" or run_script == "n" or run_script == "No":sys.exit()
elif run_script == "yes" or run_script == "y" or run_script == "Yes":
	pass
...
def Banner_Tool():
	...
	print Fore.BLUE+"\t\t << Telegram : t.me/BlackWolves_Cyber >> "
	print Fore.MAGENTA+"\t\t_______________________________________\n"
...
if Follow_Us == "yes" or Follow_Us == "Yes" or Follow_Us == "y" or Follow_Us == "Y" or Follow_Us == "YES":
	web.open("https://t.me/BlackWolves_Cyber")
	pass
